...
public class Types{
	...
	public enum ExplicitStatus{none(0), paralysis(1), poison(2), sleep(3), burn(4), frozen(5);
private int typeIndex;
	
	private int type;
	private ExplicitStatus(int type){this.type = type;}
	...
	public enum ImplicitStatus{none(0), confusion(1), bound(2), infatuation(3), fear(4);
private int typeIndex;
	
	private int type;
	private ImplicitStatus(int type){this.type = type;}
	...
	public enum AttackEffects{none(0), recharge(1), fly(2), dig(3), paralysis(4), poison(5), sleep(6), burn(7), frozen(8), confusion(9), 
		bound(10), infatuation(11), fear(12);
	
private int typeIndex;
	
	private int type;
	private AttackEffects(int type){this.type = type;}
